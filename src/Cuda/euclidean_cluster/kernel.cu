 ...
 */
__global__ void parallelRadiusSearch(
	const int* __restrict__ point_index, int start_index, int search_points, 
	bool* __restrict__ indices, const bool* __restrict__ sqr_distances, int cloud_size)
{
	...
	unsigned int max_pts_per_cluster)
{
	...
	dim3 blockdim((cloud_size+THREADS-1)/THREADS);
