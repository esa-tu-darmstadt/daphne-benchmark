...
#define EPHOS_DEVICE_NAME_S STRINGIFY(EPHOS_DEVICE_NAME)
#else
#define EPHOS_DEVICE_NAME_S ""
#endif

#ifdef EPHOS_PLATFORM_NAME
#define EPHOS_PLATFORM_NAME_S STRINGIFY(EPHOS_PLATFORM_NAME)
#else
...
private:
	...
	cl::sycl::buffer<Voxel, 3> voxelGridBuffer;
public:
	ndt_mapping();
public:
	virtual void init();
